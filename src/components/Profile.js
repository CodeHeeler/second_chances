...
class Profile extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Header/>
                <h1 style={styles.profileHeading}>Welcome! Your Profile</h1>
                <div style={styles.headerBar}>
                    <h1 style={styles.mainName}>Smitty Werthermanjensen</h1>
                ...
                <div style={styles.profileBody}>
                    ...
                    <h1 style={styles.profileHeading}>Your Skills</h1>
                    ...
                    <h1 style={styles.profileHeading}>Your Opportunities</h1>
